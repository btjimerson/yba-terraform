...
resource "aws_route" "peer_route_1" {
  ...
  destination_cidr_block    = var.peer_public_subnet_1_cidr_block
  vpc_peering_connection_id = aws_vpc_peering_connection.main_to_peer.id
}
...
resource "aws_route" "peer_route_2" {
  provider                  = aws.main
  route_table_id            = var.main_public_route_table_id
  destination_cidr_block    = var.peer_public_subnet_2_cidr_block
  vpc_peering_connection_id = aws_vpc_peering_connection.main_to_peer.id
}
...
resource "aws_route" "peer_route_3" {
  provider                  = aws.main
  route_table_id            = var.main_public_route_table_id
  destination_cidr_block    = var.peer_public_subnet_3_cidr_block
  vpc_peering_connection_id = aws_vpc_peering_connection.main_to_peer.id
}

resource "aws_route" "main_route_1" {
  provider                  = aws.peer
  route_table_id            = var.peer_public_route_table_1_id
  destination_cidr_block    = var.main_public_subnet_cidr_block
  vpc_peering_connection_id = aws_vpc_peering_connection.main_to_peer.id
}

resource "aws_route" "main_route_2" {
  provider                  = aws.peer
  route_table_id            = var.peer_public_route_table_2_id
  destination_cidr_block    = var.main_public_subnet_cidr_block
  vpc_peering_connection_id = aws_vpc_peering_connection.main_to_peer.id
}

resource "aws_route" "main_route_3" {
  provider                  = aws.peer
  route_table_id            = var.peer_public_route_table_3_id
  destination_cidr_block    = var.main_public_subnet_cidr_block
  vpc_peering_connection_id = aws_vpc_peering_connection.main_to_peer.id
}